...
const days = [
  ...
  {
    date: "Friday",
    title: "Fun Day at Miner's Landing",
    vibe: "Pike Place and Miner's Landing.",
    stripe: "#d65f45",
    outfit: "Comfortable shoes during the day.",
    plan: [
      ["First", "Pike Place Market"],
      ["Then", "Wings Over Washington"],
      ["Then", "Seattle Great Wheel"],
      ["Then", "Carousel"],
      ["Then", "Sasquatch"],
      ["Then", "Salish Sea Tour"],
      ["After", "Come home and chill"],
    ],
  },
  {
    date: "Saturday",
